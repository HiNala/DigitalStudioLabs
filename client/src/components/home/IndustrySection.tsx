            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="dark:text-[#8B949E] light:text-gray-600 mb-6">
                  Transform your retail business with cutting-edge digital solutions. From inventory management to customer analytics and seamless POS integration.
                </p>
                <div className="flex flex-wrap gap-2">
                  {['E-commerce', 'POS Systems', 'Inventory', 'Analytics'].map((tag, tagIndex) => (
                    <motion.span 
                      key={tagIndex} 
