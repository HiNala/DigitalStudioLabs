...
export function SplineHero() {
  return (
    <section className="w-full h-[700px] md:h-[600px] relative overflow-hidden">
      ...
      {/* Centered content - positioned lower on the page */}
      <div className="relative z-10 flex items-center justify-center h-full w-full pt-32">
        <div className="max-w-4xl text-center p-8 rounded-xl relative overflow-hidden">
          {/* Gradient backdrop that fades at the edges */}
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/30 to-transparent backdrop-blur-sm"></div>
